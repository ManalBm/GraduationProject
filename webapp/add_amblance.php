...
<nav class="nav">
    <div class="nav-logo">
        ...
        <div class="nav-menu" id="navMenu">
            <ul>
                ...
                <li><a href="Ambulace.html" class="link active">Ambulace</a></li>
    ...
    <div class="container">
       ...
       <table class="table table-hover text-center " style="color: #fff;">
            <thead class="table-dark" style="background: #fff; color: #000;">
                <tr>
                    <th scope="col">N°Ambulance</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>QRHQ+93Q</td>
                    <td>
                         <a href="" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"style="color: #000;"></i></a>
                         <a href="" class="link-dark"><i class="fa-solid fa-trash fs-5 " style="color: #000;"></i></a>
